...
<template>
    ...
    <div class="grid grid-cols-3 gap-3 items-start text-xs w-full max-w-3xl mx-auto px-1 mb-4">
        ...
        <div class="flex min-w-0 flex-col items-center text-center">
            ...
            <p class="w-full whitespace-normal break-words [overflow-wrap:anywhere] font-bold underline mt-1 text-black leading-tight">{{ values.penyetuju_akhir || 'Bpk. Nugroho Samudra Sujatmiko, Ko' }}</p>
