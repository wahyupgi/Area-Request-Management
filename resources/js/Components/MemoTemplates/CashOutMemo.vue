...
<template>
    ...
    <div class="grid grid-cols-[0.8fr_0.8fr_1.4fr] gap-1 items-start text-xs w-full max-w-3xl mx-auto px-1 mb-4">
        <div class="flex min-w-0 flex-col items-center text-center">
            ...
            <p class="w-full whitespace-normal break-words [overflow-wrap:anywhere] mt-1 text-black leading-tight">{{ memo.creator?.name }}</p>
        ...
        <div class="flex min-w-0 flex-col items-center text-center">
            ...
            <p class="w-full whitespace-normal break-words [overflow-wrap:anywhere] mt-1 text-black leading-tight">{{ memo.area_manager?.name || 'Bpk. Fathurrahman M' }}</p>
